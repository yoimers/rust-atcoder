...
impl LCA {
  ...
  pub fn lca(&self, u: usize, v: usize) -> usize {
    let (mut v0, mut v1) = if self.depth[u] <= self.depth[v] { (u, v) } else { (v, u) };
...
#[test]
fn test_lca() {
  let tree = vec![vec![1, 2], vec![0, 3, 4], vec![0, 5], vec![1], vec![1, 6, 7], vec![2], vec![4], vec![4]];
  let e = vec![(0, 1), (0, 2), (1, 3), (1, 4), (2, 5), (4, 6), (4, 7)];
  ...
  let q = vec![(1, 2, 0, 2), (3, 7, 1, 3), (4, 4, 4, 0), (3, 5, 0, 4), (1, 7, 1, 2), (2, 5, 2, 1)];
  for (u, v, p, d) in q {
